          ...
          <div className="space-y-6">
            {messages.map((m, idx) => (
              ...
              >
                {/* Avatar */}
                <div
                  className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center text-[10px] font-pixelify font-bold transition-colors duration-500 ${
                    m.role === 'user'
                ...
                <div className="flex-1 min-w-0 max-w-[85%]">
                  {/* Role label */}
                  <div
                    className={`font-stzhongsong text-xs mb-1.5 ${
                      m.role === 'user'
